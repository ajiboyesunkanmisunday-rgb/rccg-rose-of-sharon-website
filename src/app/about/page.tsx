    ...
    <main>
      ...
      <section className="relative h-[600px] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute left-1/2 top-[calc(50%+48px)] -translate-x-1/2 -translate-y-1/2 flex flex-col gap-[24px] items-center w-[1148px] z-10 text-center">
          <p className="text-[#B5B5F3] text-[16px] font-normal uppercase tracking-[0.15em]" style={vs}>Who We Are</p>
          <h1 className="text-[#FFFDFD] text-[72px] font-medium leading-normal w-full" style={vs}>Meet the Church</h1>
      ...
      {/* Who We Are */}
      <section id="about" className="bg-[#100E1A] px-[120px] py-[84px] flex flex-col gap-[48px] items-center w-full">
        <div className="flex gap-[64px] items-center w-full">
          <div className="flex flex-col gap-[24px] flex-1 min-w-0">
            <p className="text-[#B5B5F3] text-[16px] font-normal uppercase tracking-[0.15em]" style={vs}>Our Story</p>
            <h2 className="text-[#FFFDFD] text-[48px] font-bold leading-[1.2]" style={vs}>
              RCCG Rose of Sharon
            </h2>
            ...
            <div className="flex gap-[16px] flex-wrap">
              <Link
                href="/first-timer"
                className="px-[32px] py-[14px] bg-[#000080] text-[#FFFDFD] text-[16px] font-medium rounded-[30px] hover:bg-[#0000a0] transition-colors"
                style={vs}
              >
                I&apos;m a First Timer
              </Link>
              <Link
                href="/e-member"
                className="px-[32px] py-[14px] border-2 border-[#B5B5F3] text-[#B5B5F3] text-[16px] font-medium rounded-[30px] hover:bg-[#B5B5F3]/10 transition-colors"
                style={vs}
              >
                Become an E-Member
              </Link>
          ...
          <div className="relative w-[500px] h-[420px] flex-shrink-0 rounded-[24px] overflow-hidden">
      ...
      <section className="bg-[#D2D2E2] px-[120px] py-[84px] flex flex-col gap-[48px] items-center w-full">
        <div className="flex flex-col gap-[8px] items-center text-center">
          <p className="text-[#000080] text-[16px] font-normal uppercase tracking-[0.15em]" style={vs}>Join Us</p>
          <h2 className="text-[#100E1A] text-[48px] font-bold leading-normal" style={vs}>Service Times</h2>
          <p className="text-[#A3A1AF] text-[18px] font-normal" style={vs}>
            Come as you are — everyone is welcome at any of our services.
          </p>
        </div>

        <div className="grid gap-[20px] w-full" style={{ gridTemplateColumns: "repeat(2, 1fr)" }}>
          {services.map((s) => (
            <div
              key={s.name}
              className="bg-white rounded-[16px] p-[32px] flex items-start gap-[24px] shadow-[0px_4px_20px_rgba(0,0,0,0.06)]"
            >
              <div className="flex-shrink-0 w-[90px] h-[90px] rounded-[16px] bg-[#000080] flex flex-col items-center justify-center">
                <span className="text-[#B5B5F3] text-[12px] font-medium uppercase tracking-wider" style={vs}>{s.day}</span>
                <span className="text-[#FFFDFD] text-[18px] font-bold" style={vs}>{s.time}</span>
              </div>
              <div className="flex flex-col gap-[6px] flex-1 min-w-0">
                <p className="text-[#100E1A] text-[22px] font-bold leading-normal" style={vs}>{s.name}</p>
                <p className="text-[#A3A1AF] text-[15px] font-normal leading-[1.6]" style={vs}>{s.desc}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex gap-[16px] items-center">
          ...
          <Link
            href="/announcements"
            className="px-[32px] py-[14px] border-2 border-[#000080] text-[#000080] text-[16px] font-medium rounded-[30px] hover:bg-[#000080]/10 transition-colors"
            style={vs}
          >
            Announcements
          </Link>
      ...
      <section className="bg-[#100E1A] px-[120px] py-[84px] flex flex-col gap-[48px] items-center w-full">
        <div className="flex flex-col gap-[8px] items-center text-center">
          <p className="text-[#B5B5F3] text-[16px] font-normal uppercase tracking-[0.15em]" style={vs}>Our Foundation</p>
          <h2 className="text-[#FFFDFD] text-[48px] font-bold leading-normal" style={vs}>What We Believe</h2>
        </div>
        ...
        <div className="grid gap-[20px] w-full" style={{ gridTemplateColumns: "repeat(3, 1fr)" }}>
          {beliefs.map((b, i) => (
            <div
              key={b.title}
              className="bg-[#1a1826] rounded-[16px] p-[28px] flex flex-col gap-[12px] border border-[#B5B5F3]/10 hover:border-[#B5B5F3]/25 transition-colors"
            >
              ...
              <p className="text-[#FFFDFD] text-[20px] font-bold leading-normal" style={vs}>{b.title}</p>
              <p className="text-[#A3A1AF] text-[15px] font-normal leading-[1.7]" style={vs}>{b.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Get Involved */}
      <section className="bg-[#000080] px-[120px] py-[84px] flex flex-col gap-[32px] items-center w-full text-center">
        <h2 className="text-[#FFFDFD] text-[48px] font-bold leading-normal" style={vs}>Ready to Take a Step?</h2>
        <p className="text-[#B5B5F3] text-[20px] font-normal leading-[1.7] max-w-[700px]" style={vs}>
        ...
        <div className="flex flex-wrap gap-[16px] justify-center">
          {[
            ...
            <Link
              key={l.href}
              href={l.href}
              className="px-[24px] py-[12px] border-2 border-[#B5B5F3] text-[#B5B5F3] text-[16px] font-medium rounded-[30px] hover:bg-[#B5B5F3]/20 transition-colors"
              style={vs}
            >
              {l.label}
            </Link>
