  ...
  return (
    <main>
      <section className="relative h-[735px] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute left-1/2 top-[calc(50%+58px)] -translate-x-1/2 -translate-y-1/2 flex flex-col gap-[84px] items-center w-[1148px] z-10 text-center">
      ...
      {/* Programs */}
      <section id="programs" className="bg-[#100E1A] px-[120px] py-[84px] flex flex-col gap-[48px] items-center w-full">
        ...
        <div className="flex flex-col gap-[24px] w-full">
          {programs.map((prog, i) => (
            <div
              key={prog.slug}
              className={`flex items-center gap-[48px] p-[40px] rounded-[16px] ${i % 2 === 0 ? "bg-[rgba(255,255,255,0.05)]" : "bg-[#000080]/20"} border border-[rgba(255,255,255,0.08)]`}
            >
              <div className="flex flex-col gap-[16px] flex-1">
                <h3 className="text-[#FFFDFD] text-[32px] font-bold leading-normal" style={vs}>{prog.title}</h3>
              ...
              <Link
                ...
                className="flex-shrink-0 bg-[#000080] px-[32px] py-[16px] rounded-[35px] text-[#FFFDFD] text-[20px] font-medium hover:bg-[#0000a0] transition-colors whitespace-nowrap"
                style={vs}
              >
                Register Now
              </Link>
      ...
      <section className="bg-[#D2D2E2] px-[120px] py-[84px] flex flex-col gap-[48px] items-center w-full">
        ...
        <p className="text-[#100E1A] text-[20px] font-normal leading-[1.6] text-center max-w-[800px]" style={vs}>
