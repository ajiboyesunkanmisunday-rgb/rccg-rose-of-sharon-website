...
export default function Welcome() {
  return (
    <section id="about" className="bg-[#100E1A] px-[100px] py-[84px] flex flex-col items-center justify-center gap-[32px] text-center w-full">
        <h2
        ...
        <div className="flex flex-col gap-[24px] items-center w-[1240px]">
          <p
            className="text-[#FFFDFD] text-[25px] font-medium leading-normal w-full"
            style={{ fontVariationSettings: '"wdth" 100' }}
          >
          ...
          <p className="text-[#A3A1AF] text-[20px] font-normal italic leading-[1.5] w-[1240px]">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-[32px] py-[16px] bg-[#000080] text-[#FFFDFD] text-[25px] font-medium rounded-[35px] drop-shadow-[19px_19px_20px_rgba(0,0,0,0.1)] hover:bg-[#0000a0] transition-colors"
        >
